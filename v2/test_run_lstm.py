...
if __name__ == "__main__":
    ...
    sess_id = "test_sessions/session_lstm"
    ...
    env = DummyVecEnv([make_env(i, env_config) for i in range(num_cpu)])  # FIX
    ...
    if exists(file_name + ".zip"):
        ...
        model = RecurrentPPO("MultiInputLstmPolicy", env, verbose=1, n_steps=train_steps_batch, batch_size=512, n_epochs=1, gamma=0.997, ent_coef=0.01, tensorboard_log=sess_path)
