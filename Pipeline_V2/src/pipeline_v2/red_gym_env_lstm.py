...
from pipeline_v2.global_map import local_to_global, GLOBAL_MAP_SHAPE
...
class RedGymEnvLSTM(Env):
        ...
        self.observation_space = spaces.Dict(
            {
                ...
                "recent_actions": spaces.MultiDiscrete([len(self.valid_actions)] * self.history_len),
                "episode_start": spaces.Box(low=0, high=1, shape=(1,), dtype=np.float32)
    ...
    def step(self, action):
        ...
        obs = self._get_obs()
        self.episode_start = self.step_count == 0
