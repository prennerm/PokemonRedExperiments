...
**IMPORTANT:** All visualization and analysis code must run in the dedicated visualization environment:
...
# Verify setup
python -c "from analysis import TrainingSampler; print('Analysis environment OK')"
```

**DO NOT** run visualization code in `poke_env` (training environment). See [ENVIRONMENT_SETUP.md](ENVIRONMENT_SETUP.md) for details on the two-environment system.
