...
# Data is in environments/data, we're in utils/
MAP_PATH = os.path.join(os.path.dirname(__file__), "..", "environments", "data", "map_data.json")
PAD = 20
...
if Path(MAP_PATH).is_file():
    ...
    print(f"[map_utils] Warning: map_data.json not found at {MAP_PATH}. Using fallback coordinates.")
    MAP_DATA = []
